...
export default function PaybackCalc({ industry, country, onCountryChange }: Props) {
  ...
  const calculate = () => {
    ...
    // FIXED: Payback analysis without double-counting
    ...
    const qualityScore = calculateQualityScore({
      performanceVsBenchmark: r.roi / 25, // 25% ROI as benchmark
  ...
  return (
    <div className="glass-card">
      ...
      <div className="flex justify-center mt-8">
        <button className="glass-btn" onClick={calculate}>Calculate Payback</button>
      </div>
      ...
      {results && (
        <div className="mt-12 pt-12 border-t border-foreground/10 animate-[fadeIn_0.3s_ease]">
          ...
          {/* FIXED: Inflation analysis without double-counting principal */}
          <div className="comparison-section">
